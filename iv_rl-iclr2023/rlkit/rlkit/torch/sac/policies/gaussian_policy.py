...
class TanhGaussianPolicy(Mlp, ExplorationPolicy):
    ...
    def get_action(self, obs_np, deterministic=False):
        ...
        if type(obs_np)==tuple:
            obs_np = obs_np[0]
        # print("obs_np ", obs_np, "\n")
        # print("obs_np.shape ", obs_np.shape, "\n")
        actions = self.get_actions(obs_np, deterministic=deterministic)
        # # print("obs_np[0] ", obs_np[0], "\n")
        # # print("obs_np[0].shape ", obs_np[0].shape, "\n")
        # # actions = self.get_actions(obs_np[0], deterministic=deterministic)
...
class TanhGaussianPolicy2(Mlp, TorchStochasticPolicy):
    """
    Usage:
