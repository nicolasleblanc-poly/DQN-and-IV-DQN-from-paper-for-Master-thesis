...
from rlkit.rlkit.data_management.env_replay_buffer import EnsembleEnvReplayBuffer
from rlkit.rlkit.envs.wrappers import NormalizedBoxEnv
from rlkit.rlkit.launchers.launcher_util import setup_logger_custom, set_seed
from rlkit.rlkit.samplers.data_collector import EnsembleMdpPathCollector
from rlkit.rlkit.torch.sac.policies import TanhGaussianPolicy, MakeDeterministic
from rlkit.rlkit.torch.networks import FlattenMlp, FlattenTwoHeadMlp
...
def get_env(env_name, seed):
    ...
    if env_name in ['gym_walker2d', 'gym_hopper',
                    'gym_cheetah', 'gym_ant']:
        from mbbl_envs.mbbl.env.gym_env.walker import env
